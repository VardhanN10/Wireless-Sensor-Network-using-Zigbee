...
#define GENERATED_ATTRIBUTES { \
  { 0x0000, ZCL_INT8U_ATTRIBUTE_TYPE, 1, (ATTRIBUTE_MASK_SINGLETON), { (uint8_t*)8  } }, /* 0 Cluster: Basic, Attribute: ZCL version, Side: server*/ \
		  ...
		  { 0x0000, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_WRITABLE), { (uint8_t*)0  } }, /* 4 Cluster: Identify, Attribute: identify time, Side: server*/ \
		  ...
		  { 0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_CLIENT), { (uint8_t*)3  } }, /* 7 Cluster: Temperature Measurement, Attribute: cluster revision, Side: client*/ \
		  { 0xFFFE, ZCL_ENUM8_ATTRIBUTE_TYPE, 1, (ATTRIBUTE_MASK_CLIENT), { (uint8_t*)0  } } /* 8 Cluster: Temperature Measurement, Attribute: reporting status, Side: client*/ \
		 }
...
#define GENERATED_CLUSTERS { \
  { 0x0000, (EmberAfAttributeMetadata*)&(generatedAttributes[0]), 3, 0, CLUSTER_MASK_SERVER, NULL }, /* 0, Endpoint Id: 1, Cluster: Basic, Side: server*/ \
	  ...
	  { 0x0402, (EmberAfAttributeMetadata*)&(generatedAttributes[7]), 2, 3, CLUSTER_MASK_CLIENT, NULL } /* 4, Endpoint Id: 1, Cluster: Temperature Measurement, Side: client*/ \
	 }
...
#define GENERATED_COMMANDS { \
  { 0x0003, 0x00, COMMAND_MASK_INCOMING_SERVER | COMMAND_MASK_OUTGOING_CLIENT }, /* 0, Cluster: Identify, Command: Identify*/ \
	  ...
	  { 0x0006, 0x00, COMMAND_MASK_OUTGOING_CLIENT }, /* 3, Cluster: On/off, Command: Off*/ \
	  { 0x0006, 0x01, COMMAND_MASK_OUTGOING_CLIENT }, /* 4, Cluster: On/off, Command: On*/ \
	  { 0x0006, 0x02, COMMAND_MASK_OUTGOING_CLIENT }, /* 5, Cluster: On/off, Command: Toggle*/ \
	 } 
...
#define ZCL_USING_TEMP_MEASUREMENT_CLUSTER_REPORTING_STATUS_CLIENT_ATTRIBUTE
